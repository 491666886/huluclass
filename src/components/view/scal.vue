<template>
	<div>
		<div>
			...
			<el-button v-if="show" class="add" size="small" type="primary" @click='show=false'>编辑</el-button>
			<el-button v-else='show' class="add" size="small" type="primary" @click=hold()>确定</el-button>
		</div>
			...
			<div v-else="show" class="edit">
				<el-dialog title="编辑日程" :visible.sync="dialogFormVisible1" :modal-append-to-body='false'>
					<el-form :model="form">
						...
						<el-form-item :required=true label="开始时间" :label-width="formLabelWidth">
							<el-time-picker v-model="form.value1" :picker-options="{
				...
				<el-form :model="form">
					<el-form-item label="开学日期" :label-width="formLabelWidth">
						...
						<el-date-picker v-model="form.value1" type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="选择开学日期">
						</el-date-picker>
					</el-form-item>
					<el-form-item label="放假日期" :label-width="formLabelWidth">
						<el-date-picker v-model="form.value2" type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="选择放假日期">
						</el-date-picker>
					</el-form-item>
					<el-form-item label="第一天上课日期" :label-width="formLabelWidth">
						<el-date-picker v-model="form.value3" type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="选择第一天上课日期">
						</el-date-picker>
					</el-form-item>
					...
					<el-button type="primary" style="width: 160px;">继续添加特殊日期</el-button>
				</el-form>
