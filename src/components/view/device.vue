	...
	<div>
				...
				<el-form :model='form' :rules='rules' ref='form'>
					...
					<el-form-item prop='gradeNo' label='班级' :label-width='formLabelWidth'>
						<el-input class='input' v-model='form.gradeNo' autocomplete='off' placeholder='请输入数字' onkeyup="this.value=this.value.replace(/[^\d.]/g,'');"
						 maxlength='2'></el-input>年
						<el-input class='input' placeholder='请输入数字' v-model='form.classNo' prop='classNo' autocomplete='off' onkeyup="this.value=this.value.replace(/[^\d.]/g,'');"
				...
				<el-form :model='form'>
					...
					<el-form-item prop='gradeNo' label='班级' :label-width='formLabelWidth'>
						<el-input class='input' v-model='form.gradeNo' autocomplete='off' onkeyup="this.value=this.value.replace(/[^\d.]/g,'');"
						 maxlength='2'></el-input>年
						<el-input class='input' placeholder='请输入数字' v-model='form.classNo' onkeyup="this.value=this.value.replace(/[^\d.]/g,'');"
						 maxlength='2'></el-input>班
					</el-form-item>
		...
		<div class='table'>
			<el-table :data='tableData' border :height='tableHeight'>
				...
				<el-table-column prop='tbCameraDevice.devRoom' label='教室'></el-table-column>
				<el-table-column prop='className' label='班级'>
					<!-- <template slot-scope='scope'> {{scope.row.projectName}}({{scope.row.projectCode}}) </template> -->
				</el-table-column>
				<el-table-column prop='tbCameraDevice.devCode' label='摄像头id'></el-table-column>
