  ...
  <div>
    ...
    <el-dialog title="新增用户"
      ...
      <el-form :model="form"
        ...
        <el-form-item class="input"
          ...
          <el-input v-model="form.baseUser.name"
        ...
        <!-- </div> -->
        <el-form-item class="input"
                      prop="baseUser.loginId"
                      label="账号"
                      :label-width="formLabelWidth">
          <el-input v-model="form.baseUser.loginId"
                    autocomplete="off"
        ...
        <el-form-item class="input"
                      prop="baseUser.password"
                      label="密码"
                      :label-width="formLabelWidth">
          <el-input v-model="form.baseUser.password"
                    autocomplete="off"></el-input>
        </el-form-item>
        <div class="class">
          <a>入职时间</a>
    ...
    <div class="table">
      <el-table v-if="showTable"
        ...
        <el-table-column prop="baseUser.name"
                         label="姓名"></el-table-column>
        <el-table-column prop="jobName"
                         label="学科"></el-table-column>

        <el-table-column prop="baseUser.loginId"
        ...
        <el-table-column fixed="right"
          ...
          <template slot-scope="scope">
            ...
            <el-button @click="dele(scope.row)"
                       type="text"
...
export default {
  ...
  methods: {
    ...
    edit(row) {
      ...
      this.form.baseUser.sid = JSON.parse(
