				...
				<div>
					...
					<div class="pic_img">
						<div class="pic_img_box">
							<el-upload class="avatar-uploader" :action="doUpload"  :headers="myHeaders"      :data='{sid:this.sid}'	 name="videoFile" v-bind:on-progress="uploadVideoProcess" v-bind:on-success="handleVideoSuccess"
